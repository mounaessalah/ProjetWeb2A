...
<table border="2" align="center" width="70%">
    ...
    <tr>
        ...
        <td>
                ...
                <button id="lkBtn_<?php echo $commentaire['contenu']; ?>" type="button" class="like-button" data-like="<?php echo $commentaire['contenu']; ?>">
                    <img src="like.png" alt="Like" class="small-icon">
                </button>
            </td>
        
        <td align="center">
            <form method="POST" action="updateCommentaire.php?id_forum=<?php echo $commentaire['id_forum']; ?>">
        ...
        <td>
            <a href="deleteCommentaire.php?id_forum=<?php echo $commentaire['id_forum']; ?>"onclick="return confirm ('are you sure you want to delete this record ')">Delete</a>
        </td>
    </tr>
