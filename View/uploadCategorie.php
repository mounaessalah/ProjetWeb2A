...
$categorieeC = new categorieC();
$list = $categorieC->listCategorieee();
...
if (
    ...
    if (
        ...
        // Créer un nouvel objet categorie avec les données du formulaire
        ...
        // Ajouter la categorie à la base de données
