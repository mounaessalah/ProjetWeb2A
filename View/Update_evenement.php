        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="listevenement.php">Retour</a>
                    </li>
                </ul>
            </div>
        </div>
...
function validateForm() {
    var titre = document.getElementById("titre_evenement").value;
    var description = document.getElementById("description_evenement").value;
