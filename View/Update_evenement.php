...
if (
    ...
    if (
        !empty($_POST['titre_evenement']) &&
        !empty($_POST["duretotale_evenement"]) &&
        !empty($_POST["description_evenement"]) &&
        !empty($_POST["categorie_evenement"]) &&
        !empty($_POST["prix_evenement"])
    ) {
        ...
        $evenement = new evenement(
            ...
            $_POST['duretotale_evenement'],
            $_POST['description_evenement'],
            $_POST['categorie_evenement'],
            $_POST['prix_evenement']
        );

        // Update the evenement inevenement in the database
...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
        <img src="../assets/img/logo111.png" class="navbar-brand-img h-100" alt="logo111">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        ...
        ?>
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="addStudentModalLabel">Update evenement</h5>
            </div>
                ...
                <form method="POST" id="insertForm" action="">
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" name="titre_evenement" placeholder="Titre" value="<?php echo $evenement['titre_evenement']; ?>">
                        </div>
                        <div class="col">
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            <textarea class="form-control" name="description_evenement" rows="3"><?php echo $evenement['description_evenement']; ?></textarea>
                        </div>
                    </div>
    ...
    <?php endforeach; ?>
                    ...
                    <button type="submit" class="btn btn-primary" href="listevenement.php">Update</button>
    ...
    <?php } else { ?>
        <div class="alert alert-danger">Invalid evenement</div>
    <?php } ?>
