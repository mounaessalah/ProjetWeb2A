...
if (
    isset($_POST["titre_categorie"]) 
   
) {
    if (
        !empty($_POST['titre_categorie'])
    ) {
        ...
        $categorie = new categorie(
            $id,
            $_POST['titre_categorie']
        );

        // Update the categorie incategorie in the database
        $categorieC->updatecategorie($categorie, $id);

    } else
        $error = "Missing incategorie";
}
?>
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">update categorie</h6>
        </nav>
        ...
        ?>
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="addStudentModalLabel">Update categorie</h5>
            </div>
                ...
                <form method="POST" id="insertForm" action="">
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" name="titre_categorie" placeholder="Titre" value="<?php echo $categorie['nom']; ?>">
                        </div>
                       
                    </div>

                  </div>
                    <button type="submit" class="btn btn-primary" href="listcategorie.php">Update</button>
    ...
    <?php } else { ?>
        <div class="alert alert-danger">Invalid categorie</div>
    <?php } ?>
